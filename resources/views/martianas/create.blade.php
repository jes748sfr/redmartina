<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form id="actividadForm" action="{{ route('martianas.store') }}" method="POST" autocomplete="off">
                        @csrf
    ...
    <script>
        document.getElementById('submitButton').addEventListener('click', function (event) {
            ...
            Swal.fire({
                    title: 'Una cosa mas...',
                    text: '¿Quieres agregar fotos o documentos a esta actividad martiana?',
                    icon: 'warning',
