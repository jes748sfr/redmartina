        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('directorios.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        ...
                        <div class="mb-4">
                            <div class="flex">
                                <div class="flex items-center h-5">
                                    ...
                                    <input id="visualfoto" name="visualfoto" type="checkbox" value="1" checked>
                                </div>
