        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('convocatorias.update', ['id' => $convocatoria->id]) }}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT') 
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                ...
                                required value="{{ old('titulo', $convocatoria->titulo) }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input 
                                ...
                                required value="{{ old('fecha', $convocatoria->fecha) }}">
                        </div>
                    ...
                    @if($documento == true)
                        <a class="bg-blue-500 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-600" href="{{ route('documentacion_convocatoria.edit', ['id' => $convocatoria->id]) }}">Editar archivos</a>
                    @else
                        <a class="bg-blue-500 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-600" href=" {{ route('documentacion_convocatoria.crear', ['id' => $convocatoria->id]) }}">Agregar archivos</a>
                    @endif
                </div>
            </div>
        </div>
